...
import { getApiError, useSignup } from "../../hooks/useAuth";
...
export default function SignupScreen() {
  ...
  const handleSignup = () => {
    const nextNameError = !name.trim() ? "Full name is required" : undefined;
          ...
          <View style={styles.card}>
            ...
            <Input
              ...
              onChangeText={(text) => {
                ...
                if (confirmError && confirmPassword) setConfirmError(undefined);
              }}
              secureToggle
            ...
            {signup.isError && (
              <Text style={styles.apiError}>{getApiError(signup.error)}</Text>
            )}
